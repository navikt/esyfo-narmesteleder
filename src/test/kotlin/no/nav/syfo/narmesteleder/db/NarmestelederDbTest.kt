        ...
        describe("setBehovStatusForSykmeldingWithTomBeforeAndStatus") {
            ...
            it("should update behovs where sykmelding tom is before cutoff") {
                ...
                sykmeldingDb.transaction {
                    insertSykmeldingBatch(listOf(sykmeldingEntity(fnr = fnr, tom = expiredTom, orgnummer = orgnummer)))
                }
            ...
            it("should not update behovs where sykmelding tom is after cutoff") {
                ...
                sykmeldingDb.transaction {
                    insertSykmeldingBatch(listOf(sykmeldingEntity(fnr = fnr, tom = activeTom, orgnummer = orgnummer)))
                }
            ...
            it("should not update behovs without matching sykmelding") {
                ...
                sykmeldingDb.transaction {
                    insertSykmeldingBatch(listOf(sykmeldingEntity(fnr = fnrWithSykmelding, tom = expiredTom, orgnummer = orgnummer)))
                }
            ...
            it("should not update behovs where sykmelding tom is exactly equal to cutoff") {
                ...
                sykmeldingDb.transaction {
                    insertSykmeldingBatch(listOf(sykmeldingEntity(fnr = fnr, tom = cutoffDate, orgnummer = orgnummer)))
                }
            ...
            it("should update behovs where sykmelding tom is exactly one day before cutoff") {
                ...
                sykmeldingDb.transaction {
                    insertSykmeldingBatch(listOf(sykmeldingEntity(fnr = fnr, tom = tomDate, orgnummer = orgnummer)))
                }
